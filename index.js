function gerarRecibo() {
    ...
    document.getElementById('cpf_numero').innerHTML = (document.getElementById('cpf').value).toLocaleString('pt-br');
    document.getElementById('recibo_data').innerHTML = dataAtual();
    document.getElementById('cpf').innerHTML = parseFloat(document.getElementById('cpf').value).toLocaleString('pt-br');
    window.print();
